...
gSounds = {
    ...
    ['pot-hit'] = love.audio.newSource('sounds/pot-hit.wav', 'static'),
    ['invalid-move'] = love.audio.newSource('sounds/invalid-move.wav', 'static'),
    ['projectile'] = love.audio.newSource('sounds/projectile.wav', 'static'),
}